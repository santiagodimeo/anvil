---
name: branch-guard
description: Get work onto a gitflow-appropriate branch before it begins — creates a feature branch automatically when on main, master, or develop. Use at the start of any task that will modify code.
